...
# Set via env var, e.g. PROMPT_VARIANT=v2_system python -u llm_supervisor_experiment_b.py
...
# FILE PATHS
# =====================
SENSOR_LOG_PATH    = "/scratch/rayarvid/Experiments/experiment_b/festo_live/json_data.txt"
LLM_CONTROL_PATH   = "/scratch/rayarvid/Experiments/experiment_b/festo_live/llm_control.json"
# Summary + unified log are split per variant so multiple runs don't clobber each other.
SUMMARY_STATS_PATH = f"/scratch/rayarvid/Experiments/experiment_b/festo_live/llm_summary_stats_{PROMPT_VARIANT}.json"
UNIFIED_LOG_PATH   = f"/scratch/rayarvid/Experiments/experiment_b/festo_live/llm_unified_log_{PROMPT_VARIANT}.jsonl"
...
# Auto-select latest checkpoint from experiment_b adapter dir
_adapter_dir = "/scratch/rayarvid/Experiments/experiment_b/festo_llama3.2_finetuned_experiment_b"
_checkpoints = sorted(
...
# True hardware limits (matching experiment_b training context)
MAX_SAFE_TEMP   = 38.0
MAX_SAFE_LEVEL  = 70.0

# =====================
# PREDICTIVE LOOK-AHEAD CONSTANTS & HELPERS (NEW in experiment_b)
# =====================
...
# LLM SETUP
# =====================
print(f"Loading fine-tuned Llama 3.2 experiment_b model...")
...
model.eval()
print("experiment_b Model loaded - Predictive Look-Ahead capability test")
...
def build_prompt(data, recent_history):
    ...
    # Predictive look-ahead (NEW in experiment_b) — added to ALL variants
...
def main():
    ...
    print("=" * 70)
    print("LLM CONTROL AGENT experiment_b - PREDICTIVE LOOK-AHEAD TEST")
    print("=" * 70)
