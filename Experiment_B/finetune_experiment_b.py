#!/usr/bin/env python3
"""
festo_llama3.2_experiment_b — fine-tune script
...
MODEL_NAME = os.environ.get("EXP6_MODEL", "meta-llama/Llama-3.2-3B-Instruct")
DATA_PATH = HERE / "dataset_experiment_b.jsonl"
OUTPUT_DIR = HERE / "festo_llama3.2_finetuned_experiment_b"
MAX_SEQ_LEN = 512
SEED = 3407
