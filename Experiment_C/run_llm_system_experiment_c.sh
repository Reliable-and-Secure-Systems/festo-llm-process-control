...
#SBATCH --output=/scratch/rayarvid/Experiments/experiment_c/logs/experiment_c_supervisor_%j.out
#SBATCH --error=/scratch/rayarvid/Experiments/experiment_c/logs/experiment_c_supervisor_%j.err
#SBATCH --job-name=experiment_c_supervisor
...
LOG_FILE="/scratch/rayarvid/Experiments/experiment_c/logs/experiment_c_supervisor_${SLURM_JOB_ID}.log"
...
SENSOR_FILE="/scratch/rayarvid/Experiments/experiment_c/festo_live/json_data.txt"
...
for VARIANT in v1_plain v2_system v3_cot v4_fewshot; do
    ...
    PROMPT_VARIANT=$VARIANT /scratch/rayarvid/.venv/bin/python -u llm_supervisor_experiment_c.py &
    SUPERVISOR_PID=$!
