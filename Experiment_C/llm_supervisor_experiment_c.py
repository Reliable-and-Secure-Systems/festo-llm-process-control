...
# Set via env var, e.g. PROMPT_VARIANT=v2_system python -u llm_supervisor_experiment_c.py
...
# FILE PATHS
# =====================
SENSOR_LOG_PATH    = "/scratch/rayarvid/Experiments/experiment_c/festo_live/json_data.txt"
LLM_CONTROL_PATH   = "/scratch/rayarvid/Experiments/experiment_c/festo_live/llm_control.json"
# Summary + unified log are split per variant so multiple runs don't clobber each other.
SUMMARY_STATS_PATH = f"/scratch/rayarvid/Experiments/experiment_c/festo_live/llm_summary_stats_{PROMPT_VARIANT}.json"
UNIFIED_LOG_PATH   = f"/scratch/rayarvid/Experiments/experiment_c/festo_live/llm_unified_log_{PROMPT_VARIANT}.jsonl"
...
# =====================
CHECK_INTERVAL  = 5
MAX_DECISIONS   = 125   # exit naturally after this many decisions
BASE_MODEL_PATH = "meta-llama/Llama-3.2-3B-Instruct"

# Auto-select latest checkpoint from Experiment C adapter dir
_adapter_dir = "/scratch/rayarvid/Experiments/experiment_c/festo_llama3.2_finetuned_experiment_c"
_checkpoints = sorted(
...
# True hardware limits (matching Experiment C training context)
MAX_SAFE_TEMP   = 38.0
MAX_SAFE_LEVEL  = 70.0

# =====================
# PREDICTIVE LOOK-AHEAD CONSTANTS & HELPERS
# =====================
...
# LLM SETUP
# =====================
print(f"Loading fine-tuned Llama 3.2 experiment_c model...")
...
model.eval()
print("experiment_c Model loaded - True Multivariable MPC test")
...
# =====================
# PROMPT VARIANTS — cumulative variants, predictive look-ahead added on top
# =====================
...
def build_prompt(data, recent_history):
    ...
    # Predictive look-ahead — multivariable MPC (experiment_c: equal level+temp weight)
...
def main():
    ...
    print("=" * 70)
    print("LLM CONTROL AGENT experiment_c - TRUE MULTIVARIABLE MPC TEST")
    print("=" * 70)
