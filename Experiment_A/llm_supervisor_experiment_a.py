...
# Set via env var, e.g. PROMPT_VARIANT=v2_system python -u llm_supervisor_experiment_a.py
...
SUMMARY_STATS_PATH = f"/scratch/rayarvid/experiment_a/festo_live/llm_summary_stats_{PROMPT_VARIANT}.json"
UNIFIED_LOG_PATH   = f"/scratch/rayarvid/experiment_a/festo_live/llm_unified_log_{PROMPT_VARIANT}.jsonl"
...
# v4_fewshot: v3 + 3 few-shot examples (matches the original experiment_a prompt).
