#!/usr/bin/env python3
"""
festo_llama3.2_exp08 — dataset generator  [TRUE MULTIVARIABLE MPC EDITION]
Extends exp05 with a receding-horizon lookahead:
...
OUT_FILE = Path(__file__).parent / "dataset_exp08.jsonl"
